      ...
      <SpaceBetween size="m">
        ...
        <div>
          ...
          <Box>
            <dl className="product-details" aria-label="Product details">
              <dt>Sold by</dt>
              <dd>
                <Link href="src/pages/product-detail-page#" external={true} variant="primary">
                  Cloud Data
                </Link>
              </dd>
        ...
        <Box margin={{ top: 'xs' }}>
          <Container
            media={{
              content: (
                <Link href="src/pages/product-detail-page#">
          ...
          >
            <SpaceBetween direction="vertical" size="xxs">
              ...
              <Box variant="h2" tagOverride="h3">
                <Link fontSize="heading-m" href="src/pages/product-detail-page#">
                  Video Title
                </Link>
              </Box>
            </SpaceBetween>
        ...
        <div>
          ...
          <SpaceBetween size="m">
            <Box variant="p">
              ...
              below.
              <br />
              <Link href="src/pages/product-detail-page#" variant="primary" external={true}>
      ...
      <SpaceBetween size="m">
        <div>
          <Box variant="p">
            ...
            reports.{' '}
            <Link href="src/pages/product-detail-page#" variant="primary">
              Contact us
            </Link>{' '}
      ...
      <SpaceBetween size="m">
        <div>
          ...
          <Box variant="p">
            ...
            <Link
              href="src/pages/product-detail-page#"
              external={true}
              variant="primary"
    ...
    <section className="page-section" aria-label="Support">
      ...
      <SpaceBetween size="m">
        ...
        <div>
          ...
          <Link href="src/pages/product-detail-page#" external={true} variant="primary" ariaLabel="Learn more about Cloud Support">
            Learn more
          </Link>
        </div>
        <div>
