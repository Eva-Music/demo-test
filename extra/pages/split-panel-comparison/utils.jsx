    ...
    body: (
      <ColumnLayout columns="4" variant="text-grid">
        <div>
          ...
          <Link variant="awsui-value-large" href="src/pages/split-panel-comparison#" ariaLabel={`Running instances (${enabled})`}>
            {enabled}
          </Link>
        </div>
        <div>
          <Box variant="awsui-key-label">Volumes</Box>
          <Link variant="awsui-value-large" href="src/pages/split-panel-comparison#" ariaLabel={`Volumes (${volumes})`}>
            {volumes}
          </Link>
        </div>
        <div>
          <Box variant="awsui-key-label">Security groups</Box>
          <Link variant="awsui-value-large" href="src/pages/split-panel-comparison#" ariaLabel={`Security groups (${securityGroups})`}>
            {securityGroups}
          </Link>
        </div>
        <div>
          <Box variant="awsui-key-label">Load balancers</Box>
          <Link variant="awsui-value-large" href="src/pages/split-panel-comparison#" ariaLabel={`Load balancers (${loadBalancers})`}>
            {loadBalancers}
          </Link>
        </div>
      </ColumnLayout>
